...
headers = {
    ...
    'Cookie': '''loginScene=102003; SUB=_2A25y-TfjDeRhGeNH6VEZ8yrOyj6IHXVuAlmrrDV6PUJbkdANLUr5kW1NStoBAxUXm4AMue63pAiZGZi_g9XMN2Jg; MLOGIN=1; _T_WM=28647536337; M_WEIBOCN_PARAMS=lfid%3D102803%26luicode%3D20000174; WEIBOCN_FROM=1110106030'''
}

class WeiboCommentScrapy():

    def __init__(self,wid,max_num):
        global headers
    ...
    def get_one_comment_struct(self,comment):
        ...
        # return {"userURL":userURL,"nickName":nickName,"sex":sex,"location":location,"weiboNum":weiboNum,"followingNum":followingNum,"followsNum":followsNum,"content":content,"praisedNum":praisedNum,"publish_time":publish_time}
        return {"userURL":userURL,"content":content,"praisedNum":praisedNum,"publish_time":publish_time}
    ...
    def run(self):
        ...
        if self.max_num != 1:
            ...
            pageNum = min(self.max_num,pageNum)
...
if __name__ =="__main__":
    CommentScrapy = WeiboCommentScrapy('IaYZIu0Ko',1)
    results = CommentScrapy.run()
    print(results)